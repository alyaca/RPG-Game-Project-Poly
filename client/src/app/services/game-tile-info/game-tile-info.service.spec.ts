...
describe('GameTileInfoService', () => {
  ...
  beforeEach(() => {
    const tileServiceMock = jasmine.createSpyObj('TileService', ['getTileImage']);
    const navigationServiceMock = jasmine.createSpyObj('NavigationService', [], { players: [] });
    ...
    tileServiceSpy = TestBed.inject(TileService) as jasmine.SpyObj<TileService>;
